import{L as le}from"./Login-l5AYts2r.js";import"./iframe-BmjDsDSI.js";import"./preload-helper-C1FmrZbK.js";import"./data-BFaQfHGI.js";import"./chrome-CpGI2NAX.js";import"./useHideShadowAtScrollEnd-Ca56KO1k.js";import"./Menu-DOmgzXPq.js";import"./logo-4d3YAuGj.js";import"./Button-DW5od6O8.js";import"./Typography-CukSYaFg.js";import"./CardFeedbackIcons-CtGtnROb.js";import"./Steps-yCiU_9iD.js";import"./FormHeader-lgGMQQWa.js";import"./Toast-C2lOAzk8.js";import"./Checkbox-B1NZuJJI.js";import"./Check-DPnOaUaQ.js";import"./Input-DPgWgRRb.js";import"./input-hint-Df5FGfdI.js";import"./warning-BDZVGyA5.js";import"./Tooltip-Cyeh6ZME.js";import"./InputMask-DkHmo_JK.js";import"./Divider-CGn9xCWT.js";import"./InputSelect-NvmRycFl.js";import"./Breadcrumb-YUwODi1i.js";import"./Breadcrumb.module-DW62jzuC.js";import"./CardFeedback-Bg-yi8LC.js";const De={title:"Pages/Super App/Login/Cenários",component:le,parameters:{layout:"fullscreen",viewport:{defaultViewport:"mobile"},docs:{description:{component:`Uma story por jornada real do cliente.
...
análise estática e só enxerga o \`name\` declarado inline.`}}}},e={name:"1-ContaComVinculo",args:{initialStep:"welcome",vinculoInicial:"automatico"},parameters:{docs:{description:{story:`O usuário já tem conta e já tem uma ou mais unidades ligadas a ela. Ele entra com e-mail e senha e o app encontra o vínculo que já existe: ele foi criado no cadastro, quando o CPF foi conferido no sistema comercial. Se tiver mais de uma unidade, escolhe com qual quer entrar; se tiver só uma, vai direto para a home dela.
...
Fonte: CA33, CA34, CA43.`}}}},t={name:"3-EmailDivergente",args:{initialStep:"welcome"},parameters:{docs:{description:{story:`O usuário tem conta e nenhuma unidade ligada a ela. Ele informa o CPF/CNPJ e o estado, o sistema comercial reconhece o CPF e devolve o e-mail que está lá, e esse e-mail é diferente do da conta. Antes de vincular, o app pede uma prova de identidade: documento com foto e selfie. Aprovada, o e-mail é atualizado e as unidades entram na conta.
Se o reconhecimento falhar ou se ele preferir continuar depois, o app o leva aos Serviços Simplificados.
...
Fonte: US02 + Figma (divergência D5). Sem CA próprio: os critérios da US02 vão de CA01 a CA10 e nenhum cita rede social. O CA12 do épico é o login por rede social, não o cadastro.`}}}},o={name:"9-NaoETitular",args:{initialStep:"welcome"},parameters:{docs:{description:{story:`O usuário tem conta e nenhuma unidade ligada a ela. Ele informa o CPF/CNPJ e o estado, e o CPF não consta no sistema comercial: o app mostra a mensagem de erro e não exibe dado de unidade nenhuma. Ele é redirecionado para os Serviços Simplificados, que funcionam sem unidade vinculada.
...
Fonte: CA27, CA28.`}}}},l={name:"12-SemBiometria",args:{initialStep:"welcome",aparelhoComBiometria:!1,vinculoInicial:"automatico"},parameters:{docs:{description:{story:`O aparelho não tem biometria configurada. Toque em Fazer login, entre com o e-mail e a senha e repare: a oferta de biometria não aparece e a jornada segue direto para o consentimento. A oferta só é feita quando o aparelho tem biometria configurada (CA24).
...
Fonte: CA15 a CA19, RN13.`}}}},u={name:"14-ServicoBloqueado",args:{initialStep:"home"},parameters:{docs:{description:{story:`Na home, um serviço de empresa que ele não autorizou aparece com o selo Liberar. Ao tocar, o app mostra quais órgãos e dados aquela empresa acessa e pede a autorização. Autorizando, o serviço libera na hora. Se voltar sem autorizar, ele continua bloqueado.

Fonte: CA20, CA21, CA22, RN14.`}}}},Ge=["Cenario01ContaComVinculo","Cenario02ContaSemVinculo","Cenario03EmailDivergente","Cenario04NaoSeIdentifica","Cenario05SemContaEmailExistente","Cenario06SemContaAlteraEmail","Cenario07NaoECliente","Cenario08CadastroRedeSocial","Cenario09NaoETitular","Cenario10SemUnidadesNoEstado","Cenario11BiometriaAtiva","Cenario12SemBiometria","Cenario13Consentimento","Cenario14ServicoBloqueado"];var C,E,x,S,g;e.parameters={...e.parameters,docs:{...(C=e.parameters)==null?void 0:C.docs,source:{originalSource:`{
  ...
  parameters: {
    docs: {
      description: {
        story: "O usuário já tem conta e já tem uma ou mais unidades ligadas a ela. Ele entra com e-mail e senha e o app encontra o vínculo que já existe: ele foi criado no cadastro, quando o CPF foi conferido no sistema comercial. Se tiver mais de uma unidade, escolhe com qual quer entrar; se tiver só uma, vai direto para a home dela.\\n\\nFonte: CA32."
      }
    }
  }
}`,...(x=(E=e.parameters)==null?void 0:E.docs)==null?void 0:x.source},description:{story:"Grupo 1 · Já tem conta (faz login)",...(g=(S=e.parameters)==null?void 0:S.docs)==null?void 0:g.description}}};var A,f,v;i.parameters={...i.parameters,docs:{...(A=i.parameters)==null?void 0:A.docs,source:{originalSource:`{
...
}`,...(v=(f=i.parameters)==null?void 0:f.docs)==null?void 0:v.source}}};var F,h,q;t.parameters={...t.parameters,docs:{...(F=t.parameters)==null?void 0:F.docs,source:{originalSource:`{
  ...
  parameters: {
    docs: {
      description: {
        story: "O usuário tem conta e nenhuma unidade ligada a ela. Ele informa o CPF/CNPJ e o estado, o sistema comercial reconhece o CPF e devolve o e-mail que está lá, e esse e-mail é diferente do da conta. Antes de vincular, o app pede uma prova de identidade: documento com foto e selfie. Aprovada, o e-mail é atualizado e as unidades entram na conta.\\nSe o reconhecimento falhar ou se ele preferir continuar depois, o app o leva aos Serviços Simplificados.\\n\\nNa demo, informe um CPF/CNPJ contendo 999 para o e-mail divergir.\\n\\nFonte: CA35 a CA38."
      }
    }
  }
...
}`,...(w=(O=a.parameters)==null?void 0:O.docs)==null?void 0:w.source},description:{story:"Grupo 2 · Não tem conta (primeiro acesso)",...(B=(z=a.parameters)==null?void 0:z.docs)==null?void 0:B.description}}};var j,U,J;m.parameters={...m.parameters,docs:{...(j=m.parameters)==null?void 0:j.docs,source:{originalSource:`{
...
}`,...(J=(U=m.parameters)==null?void 0:U.docs)==null?void 0:J.source}}};var R,I,V;d.parameters={...d.parameters,docs:{...(R=d.parameters)==null?void 0:R.docs,source:{originalSource:`{
  name: "7-NaoECliente",
  args: {
    initialStep: "welcome"
  },
...
}`,...(V=(I=d.parameters)==null?void 0:I.docs)==null?void 0:V.source}}};var D,G,L;c.parameters={...c.parameters,docs:{...(D=c.parameters)==null?void 0:D.docs,source:{originalSource:`{
  ...
  parameters: {
    docs: {
      description: {
        story: "O usuário tem conta e nenhuma unidade ligada a ela. Ele informa o CPF/CNPJ e o estado, e o CPF não consta no sistema comercial: o app mostra a mensagem de erro e não exibe dado de unidade nenhuma. Ele é redirecionado para os Serviços Simplificados, que funcionam sem unidade vinculada.\\n\\nFonte: US10, CA39."
      }
    }
  }
...
}`,...(Z=(Y=n.parameters)==null?void 0:Y.docs)==null?void 0:Z.source},description:{story:"Grupo 4 · Acessos seguintes",...(ee=($=n.parameters)==null?void 0:$.docs)==null?void 0:ee.description}}};var ae,oe,ne;l.parameters={...l.parameters,docs:{...(ae=l.parameters)==null?void 0:ae.docs,source:{originalSource:`{
  ...
  parameters: {
    docs: {
      description: {
        story: "O aparelho não tem biometria configurada. Toque em Fazer login, entre com o e-mail e a senha e repare: a oferta de biometria não aparece e a jornada segue direto para o consentimento. A oferta só é feita quando o aparelho tem biometria configurada (CA24).\\nO caminho com a oferta está na story \`OfertaBiometria\`.\\n\\nFonte: CA24."
      }
    }
  }
}`,...(ne=(oe=l.parameters)==null?void 0:oe.docs)==null?void 0:ne.source}}};var re,ie,te,se,me;r.parameters={...r.parameters,docs:{...(re=r.parameters)==null?void 0:re.docs,source:{originalSource:`{
...
}`,...(te=(ie=r.parameters)==null?void 0:ie.docs)==null?void 0:te.source},description:{story:"Grupo 5 · Consentimento e serviços bloqueados",...(me=(se=r.parameters)==null?void 0:se.docs)==null?void 0:me.description}}};var de,ce,pe;u.parameters={...u.parameters,docs:{...(de=u.parameters)==null?void 0:de.docs,source:{originalSource:`{
...
}`,...(pe=(ce=u.parameters)==null?void 0:ce.docs)==null?void 0:pe.source}}};export{e as Cenario01ContaComVinculo,i as Cenario02ContaSemVinculo,t as Cenario03EmailDivergente,s as Cenario04NaoSeIdentifica,a as Cenario05SemContaEmailExistente,m as Cenario06SemContaAlteraEmail,d as Cenario07NaoECliente,c as Cenario08CadastroRedeSocial,o as Cenario09NaoETitular,p as Cenario10SemUnidadesNoEstado,n as Cenario11BiometriaAtiva,l as Cenario12SemBiometria,r as Cenario13Consentimento,u as Cenario14ServicoBloqueado,Ge as __namedExportsOrder,De as default};
